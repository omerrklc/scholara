...
export default function CommunityScreen() {
  ...
  const header = <View style={styles.header}>
    <View style={styles.titleRow}><View style={styles.titleContent}><SectionTitle eyebrow="Community" title="Questions travel farther together." subtitle="Learn from people who are living the same academic moments." /></View><NotificationBell /></View>
