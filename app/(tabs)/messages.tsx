...
const messageTime = (value: string | null, locale: string) => value ? new Date(value).toLocaleDateString(locale, { month: 'short', day: 'numeric' }) : '';
