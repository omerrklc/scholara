...
export function ResearcherCard({ person, saved, connectionState, saving = false, connecting = false, onPass, onSave, onConnect, onSafety }: { person: Researcher; saved: boolean; connectionState?: ConnectionState; saving?: boolean; connecting?: boolean; onPass: () => void; onSave: () => void; onConnect: () => void; onSafety?: () => void }) {
